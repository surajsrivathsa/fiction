				 ...
				 Map<String, double[]> bookChunks =  corpus.getValue();
				 	for(Map.Entry<String, double[]> chunks: bookChunks.entrySet()){//loop_over_all_chunks_of_a_given_book
				 		...
				 		double[] chunk_vector = chunks.getValue();
				 		 ...
				 		 {
				 			 if(i <= 20)
				 				final_chunk_vector[i] = chunk_vector[i] * FRConstants.CHUNK_WEIGHT[iter]/20;
				 			 else if (i == 21)
				 				final_chunk_vector[i] = chunk_vector[i] * FRConstants.CHAR_WEIGHT[iter];
				 			else if (i == 22)
				 				final_chunk_vector[i] = chunk_vector[i] * FRConstants.NUMCHAR_WEIGHT[iter];
				 			else if (i == 23)
				 				final_chunk_vector[i] = chunk_vector[i] * FRConstants.TTR_WEIGHT[iter]; 
				 			else if (i >23 && i <=33)
