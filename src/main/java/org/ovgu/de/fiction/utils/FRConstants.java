...
public interface FRConstants {
	...
	/* feature related */
	public static final int LEAVE_LAST_K_ELEMENTS_OF_FEATURE = 4; //exclude 2 global elements (TTR, NUM_Chars) from
	
	public static final int CHAR_RAT = 20;
	
	public static final int DIALOG_RAT = 21;
